...
namespace SnakeBasic.Entities
{
    public class Entity
    {
        ...
        /// <summary>
        /// Initializes a new instance of SnakeBasic.Entitys.Entity class.
        /// </summary>
        public Entity()
        {
        ...
        /// <summary>
        /// Finds the first entity beeing in the close range of the given argument, if found; otherwise: null. Searching clockwise.
        /// </summary>
        /// <param name="obj">Specifies the origin object.</param>
